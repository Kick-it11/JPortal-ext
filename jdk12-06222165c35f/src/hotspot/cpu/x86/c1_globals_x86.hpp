...
define_pd_global(uintx,  JPortalReservedCodeCacheSize, 16*M );
define_pd_global(uintx,  JPortalNonProfiledCodeHeapSize,7*M );
define_pd_global(uintx,  JPortalProfiledCodeHeapSize,  8*M );
