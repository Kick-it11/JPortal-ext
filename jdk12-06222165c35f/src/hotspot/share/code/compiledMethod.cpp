...
CompiledMethod::CompiledMethod(Method* method, const char* name, CompilerType type, const CodeBlobLayout& layout,
                               ...
                               bool caller_must_gc_arguments, bool jportal)
  : CodeBlob(name, type, layout, frame_complete_offset, frame_size, oop_maps, caller_must_gc_arguments, jportal),
...
CompiledMethod::CompiledMethod(Method* method, const char* name, CompilerType type, int size,
                               ...
                               OopMapSet* oop_maps, bool caller_must_gc_arguments, bool jportal)
  : CodeBlob(name, type, CodeBlobLayout((address) this, size, header_size, cb), cb,
             frame_complete_offset, frame_size, oop_maps, caller_must_gc_arguments, jportal),
    _mark_for_deoptimization_status(not_marked),
    _method(method),
    _gc_data(NULL)
{
