...
class CodeletMark: ResourceMark {
 private:
  ...
  int codelet_size() {
    ...
    int codelet_size = (_mirror?AbstractInterpreter::mirror_code():(_jportal?AbstractInterpreter::jportal_code():
      AbstractInterpreter::normal_code()))->available_space() - 2*K;
 ...
 public:
  CodeletMark(InterpreterMacroAssembler*& masm,
              ...
              bool mirror = false, bool jportal = false,
