...
class TemplateInterpreter: public AbstractInterpreter {
 ...
 protected:
  ...
  static EntryPoint _jportal_trace_code;
 ...
 public:
  ...
  static bool       contains(address pc)                        { return (_normal_code != NULL && _normal_code->contains(pc) || _jportal_code != NULL && _jportal_code->contains(pc)); }
  // Debugging/printing
  static InterpreterCodelet* codelet_containing(address pc, bool jportal);
 ...
 public:
  ...
  static address    remove_activation_entry(bool jportal)                   { return jportal?_jportal_remove_activation_entry:_normal_remove_activation_entry; }
  static address    throw_exception_entry(bool jportal)                     { return jportal?_jportal_throw_exception_entry:_normal_throw_exception_entry; }
  static address    throw_ArithmeticException_entry(bool jportal)           { return jportal?_jportal_throw_ArithmeticException_entry:_normal_throw_ArithmeticException_entry; }
  static address    throw_NullPointerException_entry(bool jportal)          { return jportal?_jportal_throw_NullPointerException_entry:_normal_throw_NullPointerException_entry; }
  static address    throw_StackOverflowError_entry(bool jportal)            { return jportal?_jportal_throw_StackOverflowError_entry:_normal_throw_StackOverflowError_entry; }

  // Code generation
#ifndef PRODUCT
  static address    trace_code    (TosState state, bool jportal)              { return jportal?_jportal_trace_code.entry(state):_normal_trace_code.entry(state); }
#endif // !PRODUCT
  static address*   dispatch_table(TosState state, bool jportal)              { return jportal?_jportal_active_table.table_for(state):_normal_active_table.table_for(state); }
  static address*   dispatch_table(bool jportal)                            { return jportal?_jportal_active_table.table_for():_normal_active_table.table_for(); }
  static int        distance_from_dispatch_table(TosState state, bool jportal){ return jportal?_jportal_active_table.distance_from(state):_normal_active_table.distance_from(state); }
  static address*   normal_table(TosState state, bool jportal)                { return jportal?_jportal_normal_table.table_for(state):_normal_normal_table.table_for(state); }
  static address*   normal_table(bool jportal)                              { return jportal?_jportal_normal_table.table_for():_normal_normal_table.table_for(); }
  static address*   safept_table(TosState state, bool jportal)                { return jportal?_jportal_safept_table.table_for(state):_normal_safept_table.table_for(state); }

  // Support for invokes
  static address*   invoke_return_entry_table(bool jportal)                 { return jportal?_jportal_invoke_return_entry:_normal_invoke_return_entry; }
  static address*   invokeinterface_return_entry_table(bool jportal)        { return jportal?_jportal_invokeinterface_return_entry:_normal_invokeinterface_return_entry; }
  static address*   invokedynamic_return_entry_table(bool jportal)          { return jportal?_jportal_invokedynamic_return_entry:_normal_invokedynamic_return_entry; }
  static int        TosState_as_index(TosState state);

  static address* invoke_return_entry_table_for(Bytecodes::Code code, bool jportal);

  static address deopt_entry(TosState state, int length, bool jportal);
  static address deopt_reexecute_return_entry(bool jportal)                 { return jportal?_jportal_deopt_reexecute_return_entry:_normal_deopt_reexecute_return_entry; }
  static address return_entry(TosState state, int length, Bytecodes::Code code, bool jportal);
