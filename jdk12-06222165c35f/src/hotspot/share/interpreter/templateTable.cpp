...
Bytecodes::Code Template::bytecode() const {
  ...
  if (i < 0 || i >= Bytecodes::number_of_codes) i = this - TemplateTable::_mirror_template_table;
  if (i < 0 || i >= Bytecodes::number_of_codes) i = this - TemplateTable::_mirror_template_table_wide;
...
Template                   TemplateTable::_mirror_template_table     [Bytecodes::number_of_codes];
Template                   TemplateTable::_mirror_template_table_wide[Bytecodes::number_of_codes];
...
void TemplateTable::def(Bytecodes::Code code, int flags, TosState in, TosState out, void (*gen)(), char filler, bool mirror) {
  assert(filler == ' ', "just checkin'");
  def(code, flags, in, out, (Template::generator)gen, 0, mirror);
}


void TemplateTable::def(Bytecodes::Code code, int flags, TosState in, TosState out, void (*gen)(int arg), int arg, bool mirror) {
  ...
  Template* t = is_wide ? template_for_wide(code, mirror) : template_for(code, mirror);
  // setup entry
...
void TemplateTable::def(Bytecodes::Code code, int flags, TosState in, TosState out, void (*gen)(Operation op), Operation op, bool mirror) {
  def(code, flags, in, out, (Template::generator)gen, (int)op, mirror);
}


void TemplateTable::def(Bytecodes::Code code, int flags, TosState in, TosState out, void (*gen)(bool arg    ), bool arg, bool mirror) {
  def(code, flags, in, out, (Template::generator)gen, (int)arg, mirror);
}


void TemplateTable::def(Bytecodes::Code code, int flags, TosState in, TosState out, void (*gen)(TosState tos), TosState tos, bool mirror) {
  def(code, flags, in, out, (Template::generator)gen, (int)tos, mirror);
}


void TemplateTable::def(Bytecodes::Code code, int flags, TosState in, TosState out, void (*gen)(Condition cc), Condition cc, bool mirror) {
  def(code, flags, in, out, (Template::generator)gen, (int)cc, mirror);
}
...
void TemplateTable::initialize() {
  ...
  def(Bytecodes::_ldc                 , ubcp|____|clvm|____, vtos, vtos, ldc                 ,  false,false );
  def(Bytecodes::_ldc_w               , ubcp|____|clvm|____, vtos, vtos, ldc                 ,  true,false  );
  def(Bytecodes::_ldc2_w              , ubcp|____|clvm|____, vtos, vtos, ldc2_w              ,  _,false     );
  def(Bytecodes::_iload               , ubcp|____|clvm|____, vtos, itos, iload               ,  _,false     );
  ...
  def(Bytecodes::_aload_0             , ubcp|____|clvm|____, vtos, atos, aload_0             ,  _,false     );
  ...
  def(Bytecodes::_iaload              , ____|____|____|____, itos, itos, iaload              ,  _,false     );
  def(Bytecodes::_laload              , ____|____|____|____, itos, ltos, laload              ,  _,false     );
  def(Bytecodes::_faload              , ____|____|____|____, itos, ftos, faload              ,  _,false     );
  def(Bytecodes::_daload              , ____|____|____|____, itos, dtos, daload              ,  _,false     );
  def(Bytecodes::_aaload              , ____|____|____|____, itos, atos, aaload              ,  _,false     );
  def(Bytecodes::_baload              , ____|____|____|____, itos, itos, baload              ,  _,false     );
  def(Bytecodes::_caload              , ____|____|____|____, itos, itos, caload              ,  _,false     );
  def(Bytecodes::_saload              , ____|____|____|____, itos, itos, saload              ,  _,false     );
  ...
  def(Bytecodes::_iastore             , ____|____|____|____, itos, vtos, iastore             ,  _,false     );
  def(Bytecodes::_lastore             , ____|____|____|____, ltos, vtos, lastore             ,  _,false     );
  def(Bytecodes::_fastore             , ____|____|____|____, ftos, vtos, fastore             ,  _,false     );
  def(Bytecodes::_dastore             , ____|____|____|____, dtos, vtos, dastore             ,  _,false     );
  def(Bytecodes::_aastore             , ____|____|clvm|____, vtos, vtos, aastore             ,  _,false     );
  def(Bytecodes::_bastore             , ____|____|____|____, itos, vtos, bastore             ,  _,false     );
  def(Bytecodes::_castore             , ____|____|____|____, itos, vtos, castore             ,  _,false     );
  def(Bytecodes::_sastore             , ____|____|____|____, itos, vtos, sastore             ,  _,false     );
  ...
  def(Bytecodes::_ldiv                , ____|____|____|____, ltos, ltos, ldiv                ,  _,false     );
  ...
  def(Bytecodes::_lrem                , ____|____|____|____, ltos, ltos, lrem                ,  _,false     );
  ...
  def(Bytecodes::_ifeq                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , equal,false  );
  def(Bytecodes::_ifne                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , not_equal,false);
  def(Bytecodes::_iflt                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , less,false   );
  def(Bytecodes::_ifge                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , greater_equal,false);
  def(Bytecodes::_ifgt                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , greater,false);
  def(Bytecodes::_ifle                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , less_equal,false);
  def(Bytecodes::_if_icmpeq           , ubcp|____|clvm|____, itos, vtos, if_icmp             , equal,false);
  def(Bytecodes::_if_icmpne           , ubcp|____|clvm|____, itos, vtos, if_icmp             , not_equal,false);
  def(Bytecodes::_if_icmplt           , ubcp|____|clvm|____, itos, vtos, if_icmp             , less,false   );
  def(Bytecodes::_if_icmpge           , ubcp|____|clvm|____, itos, vtos, if_icmp             , greater_equal,false);
  def(Bytecodes::_if_icmpgt           , ubcp|____|clvm|____, itos, vtos, if_icmp             , greater,false);
  def(Bytecodes::_if_icmple           , ubcp|____|clvm|____, itos, vtos, if_icmp             , less_equal,false);
  def(Bytecodes::_if_acmpeq           , ubcp|____|clvm|____, atos, vtos, if_acmp             , equal,false  );
  def(Bytecodes::_if_acmpne           , ubcp|____|clvm|____, atos, vtos, if_acmp             , not_equal,false);
  def(Bytecodes::_goto                , ubcp|disp|clvm|____, vtos, vtos, _goto               ,  _,false     );
  def(Bytecodes::_jsr                 , ubcp|disp|____|____, vtos, vtos, jsr                 ,  _,false     ); // result is not an oop, so do not transition to atos
  def(Bytecodes::_ret                 , ubcp|disp|____|____, vtos, vtos, ret                 ,  _,false     );
  def(Bytecodes::_tableswitch         , ubcp|disp|____|____, itos, vtos, tableswitch         ,  _,false     );
  def(Bytecodes::_lookupswitch        , ubcp|disp|____|____, itos, itos, lookupswitch        ,  _,false     );
  def(Bytecodes::_ireturn             , ____|disp|clvm|____, itos, itos, _return             , itos,false   );
  def(Bytecodes::_lreturn             , ____|disp|clvm|____, ltos, ltos, _return             , ltos,false   );
  def(Bytecodes::_freturn             , ____|disp|clvm|____, ftos, ftos, _return             , ftos,false   );
  def(Bytecodes::_dreturn             , ____|disp|clvm|____, dtos, dtos, _return             , dtos,false   );
  def(Bytecodes::_areturn             , ____|disp|clvm|____, atos, atos, _return             , atos,false   );
  def(Bytecodes::_return              , ____|disp|clvm|____, vtos, vtos, _return             , vtos,false   );
  def(Bytecodes::_getstatic           , ubcp|____|clvm|____, vtos, vtos, getstatic           , f1_byte,false);
  def(Bytecodes::_putstatic           , ubcp|____|clvm|____, vtos, vtos, putstatic           , f2_byte,false);
  def(Bytecodes::_getfield            , ubcp|____|clvm|____, vtos, vtos, getfield            , f1_byte,false);
  def(Bytecodes::_putfield            , ubcp|____|clvm|____, vtos, vtos, putfield            , f2_byte,false);
  def(Bytecodes::_invokevirtual       , ubcp|disp|clvm|____, vtos, vtos, invokevirtual       , f2_byte,false);
  def(Bytecodes::_invokespecial       , ubcp|disp|clvm|____, vtos, vtos, invokespecial       , f1_byte,false);
  def(Bytecodes::_invokestatic        , ubcp|disp|clvm|____, vtos, vtos, invokestatic        , f1_byte,false);
  def(Bytecodes::_invokeinterface     , ubcp|disp|clvm|____, vtos, vtos, invokeinterface     , f1_byte,false);
  def(Bytecodes::_invokedynamic       , ubcp|disp|clvm|____, vtos, vtos, invokedynamic       , f1_byte,false);
  def(Bytecodes::_new                 , ubcp|____|clvm|____, vtos, atos, _new                ,  _,false     );
  def(Bytecodes::_newarray            , ubcp|____|clvm|____, itos, atos, newarray            ,  _,false     );
  def(Bytecodes::_anewarray           , ubcp|____|clvm|____, itos, atos, anewarray           ,  _,false     );
  def(Bytecodes::_arraylength         , ____|____|____|____, atos, itos, arraylength         ,  _,false     );
  def(Bytecodes::_athrow              , ____|disp|____|____, atos, vtos, athrow              ,  _,false     );
  def(Bytecodes::_checkcast           , ubcp|____|clvm|____, atos, atos, checkcast           ,  _,false     );
  def(Bytecodes::_instanceof          , ubcp|____|clvm|____, atos, itos, instanceof          ,  _,false     );
  def(Bytecodes::_monitorenter        , ____|disp|clvm|____, atos, vtos, monitorenter        ,  _,false     );
  def(Bytecodes::_monitorexit         , ____|____|clvm|____, atos, vtos, monitorexit         ,  _,false     );
  def(Bytecodes::_wide                , ubcp|disp|____|____, vtos, vtos, wide                ,  _,false     );
  def(Bytecodes::_multianewarray      , ubcp|____|clvm|____, vtos, atos, multianewarray      ,  _,false     );
  def(Bytecodes::_ifnull              , ubcp|____|clvm|____, atos, vtos, if_nullcmp          , equal,false  );
  def(Bytecodes::_ifnonnull           , ubcp|____|clvm|____, atos, vtos, if_nullcmp          , not_equal,false);
  ...
  def(Bytecodes::_ret                 , ubcp|disp|____|iswd, vtos, vtos, wide_ret            ,  _,false     );
  def(Bytecodes::_breakpoint          , ubcp|disp|clvm|____, vtos, vtos, breakpoint          ,  _,false     );

  // JVM bytecodes
  def(Bytecodes::_fast_agetfield      , ubcp|____|____|____, atos, atos, fast_accessfield    ,  atos,false  );
  def(Bytecodes::_fast_bgetfield      , ubcp|____|____|____, atos, itos, fast_accessfield    ,  itos,false  );
  def(Bytecodes::_fast_cgetfield      , ubcp|____|____|____, atos, itos, fast_accessfield    ,  itos,false  );
  def(Bytecodes::_fast_dgetfield      , ubcp|____|____|____, atos, dtos, fast_accessfield    ,  dtos,false  );
  def(Bytecodes::_fast_fgetfield      , ubcp|____|____|____, atos, ftos, fast_accessfield    ,  ftos,false  );
  def(Bytecodes::_fast_igetfield      , ubcp|____|____|____, atos, itos, fast_accessfield    ,  itos,false  );
  def(Bytecodes::_fast_lgetfield      , ubcp|____|____|____, atos, ltos, fast_accessfield    ,  ltos,false  );
  def(Bytecodes::_fast_sgetfield      , ubcp|____|____|____, atos, itos, fast_accessfield    ,  itos,false  );

  def(Bytecodes::_fast_aputfield      , ubcp|____|____|____, atos, vtos, fast_storefield     ,   atos,false  );
  def(Bytecodes::_fast_bputfield      , ubcp|____|____|____, itos, vtos, fast_storefield     ,   itos,false  );
  def(Bytecodes::_fast_zputfield      , ubcp|____|____|____, itos, vtos, fast_storefield     ,   itos,false  );
  def(Bytecodes::_fast_cputfield      , ubcp|____|____|____, itos, vtos, fast_storefield     ,  itos,false   );
  def(Bytecodes::_fast_dputfield      , ubcp|____|____|____, dtos, vtos, fast_storefield     ,  dtos,false   );
  def(Bytecodes::_fast_fputfield      , ubcp|____|____|____, ftos, vtos, fast_storefield     ,  ftos,false   );
  def(Bytecodes::_fast_iputfield      , ubcp|____|____|____, itos, vtos, fast_storefield     ,  itos,false   );
  def(Bytecodes::_fast_lputfield      , ubcp|____|____|____, ltos, vtos, fast_storefield     ,  ltos,false   );
  def(Bytecodes::_fast_sputfield      , ubcp|____|____|____, itos, vtos, fast_storefield     ,  itos,false   );
  ...
  def(Bytecodes::_fast_icaload        , ubcp|____|____|____, vtos, itos, fast_icaload        ,  _,false  );

  def(Bytecodes::_fast_invokevfinal   , ubcp|disp|clvm|____, vtos, vtos, fast_invokevfinal   , f2_byte,false  );

  def(Bytecodes::_fast_linearswitch   , ubcp|disp|____|____, itos, vtos, fast_linearswitch   ,  _,false     );
  def(Bytecodes::_fast_binaryswitch   , ubcp|disp|____|____, itos, vtos, fast_binaryswitch   ,  _,false     );

  def(Bytecodes::_fast_aldc           , ubcp|____|clvm|____, vtos, atos, fast_aldc           ,  false,false );
  def(Bytecodes::_fast_aldc_w         , ubcp|____|clvm|____, vtos, atos, fast_aldc           ,  true,false  );

  def(Bytecodes::_return_register_finalizer , ____|disp|clvm|____, vtos, vtos, _return       ,  vtos,false  );

  def(Bytecodes::_invokehandle        , ubcp|disp|clvm|____, vtos, vtos, invokehandle        , f1_byte,false);

  def(Bytecodes::_nofast_getfield     , ubcp|____|clvm|____, vtos, vtos, nofast_getfield     , f1_byte,false );
  def(Bytecodes::_nofast_putfield     , ubcp|____|clvm|____, vtos, vtos, nofast_putfield     , f2_byte,false );

  def(Bytecodes::_nofast_aload_0      , ____|____|clvm|____, vtos, atos, nofast_aload_0      ,  _,false     );
  def(Bytecodes::_nofast_iload        , ubcp|____|clvm|____, vtos, itos, nofast_iload        ,  _,false     );
  ...
  if (JPortal) {
    ...
    def(Bytecodes::_ifeq                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , equal,true   );
    def(Bytecodes::_ifne                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , not_equal,true);
    def(Bytecodes::_iflt                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , less,true    );
    def(Bytecodes::_ifge                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , greater_equal,true);
    def(Bytecodes::_ifgt                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , greater,true );
    def(Bytecodes::_ifle                , ubcp|____|clvm|____, itos, vtos, if_0cmp             , less_equal,true);
    def(Bytecodes::_if_icmpeq           , ubcp|____|clvm|____, itos, vtos, if_icmp             , equal,true   );
    def(Bytecodes::_if_icmpne           , ubcp|____|clvm|____, itos, vtos, if_icmp             , not_equal,true);
    def(Bytecodes::_if_icmplt           , ubcp|____|clvm|____, itos, vtos, if_icmp             , less,true    );
    def(Bytecodes::_if_icmpge           , ubcp|____|clvm|____, itos, vtos, if_icmp             , greater_equal,true);
    def(Bytecodes::_if_icmpgt           , ubcp|____|clvm|____, itos, vtos, if_icmp             , greater,true );
    def(Bytecodes::_if_icmple           , ubcp|____|clvm|____, itos, vtos, if_icmp             , less_equal,true);
    def(Bytecodes::_if_acmpeq           , ubcp|____|clvm|____, atos, vtos, if_acmp             , equal,true   );
    def(Bytecodes::_if_acmpne           , ubcp|____|clvm|____, atos, vtos, if_acmp             , not_equal,true);
    def(Bytecodes::_goto                , ubcp|disp|clvm|____, vtos, vtos, _goto               ,  _,true      );
    def(Bytecodes::_jsr                 , ubcp|disp|____|____, vtos, vtos, jsr                 ,  _,true      ); // result is not an oop, so do not transition to atos
    def(Bytecodes::_ret                 , ubcp|disp|____|____, vtos, vtos, ret                 ,  _,true      );
    def(Bytecodes::_tableswitch         , ubcp|disp|____|____, itos, vtos, tableswitch         ,  _,true      );
    def(Bytecodes::_lookupswitch        , ubcp|disp|____|____, itos, itos, lookupswitch        ,  _,true      );
    def(Bytecodes::_ireturn             , ____|disp|clvm|____, itos, itos, _return             , itos,true    );
    def(Bytecodes::_lreturn             , ____|disp|clvm|____, ltos, ltos, _return             , ltos,true    );
    def(Bytecodes::_freturn             , ____|disp|clvm|____, ftos, ftos, _return             , ftos,true    );
    def(Bytecodes::_dreturn             , ____|disp|clvm|____, dtos, dtos, _return             , dtos,true    );
    def(Bytecodes::_areturn             , ____|disp|clvm|____, atos, atos, _return             , atos,true    );
    def(Bytecodes::_return              , ____|disp|clvm|____, vtos, vtos, _return             , vtos,true    );
    ...
    def(Bytecodes::_invokevirtual       , ubcp|disp|clvm|____, vtos, vtos, invokevirtual       , f2_byte,true);
    def(Bytecodes::_invokespecial       , ubcp|disp|clvm|____, vtos, vtos, invokespecial       , f1_byte,true);
    def(Bytecodes::_invokestatic        , ubcp|disp|clvm|____, vtos, vtos, invokestatic        , f1_byte,true );
    def(Bytecodes::_invokeinterface     , ubcp|disp|clvm|____, vtos, vtos, invokeinterface     , f1_byte,true);
    def(Bytecodes::_invokedynamic       , ubcp|disp|clvm|____, vtos, vtos, invokedynamic       , f1_byte,true);
    ...
    def(Bytecodes::_athrow              , ____|disp|____|____, atos, vtos, athrow              ,  _,true      );
    ...
    def(Bytecodes::_monitorenter        , ____|disp|clvm|____, atos, vtos, monitorenter        ,  _,true      );
    def(Bytecodes::_monitorexit         , ____|____|clvm|____, atos, vtos, monitorexit         ,  _,true      );
    def(Bytecodes::_wide                , ubcp|disp|____|____, vtos, vtos, wide                ,  _,true      );
    def(Bytecodes::_multianewarray      , ubcp|____|clvm|____, vtos, atos, multianewarray      ,  _,true      );
    def(Bytecodes::_ifnull              , ubcp|____|clvm|____, atos, vtos, if_nullcmp          , equal,true   );
    def(Bytecodes::_ifnonnull           , ubcp|____|clvm|____, atos, vtos, if_nullcmp          , not_equal,true);
    ...
    def(Bytecodes::_ret                 , ubcp|disp|____|iswd, vtos, vtos, wide_ret            ,  _,true      );
    def(Bytecodes::_breakpoint          , ubcp|disp|clvm|____, vtos, vtos, breakpoint          ,  _,true      );
    ...
    def(Bytecodes::_fast_linearswitch   , ubcp|disp|____|____, itos, vtos, fast_linearswitch   ,  _,true      );
    def(Bytecodes::_fast_binaryswitch   , ubcp|disp|____|____, itos, vtos, fast_binaryswitch   ,  _,true      );
    ...
    def(Bytecodes::_return_register_finalizer , ____|disp|clvm|____, vtos, vtos, _return       ,  vtos,true   );

    def(Bytecodes::_invokehandle        , ubcp|disp|clvm|____, vtos, vtos, invokehandle        , f1_byte,true  );
