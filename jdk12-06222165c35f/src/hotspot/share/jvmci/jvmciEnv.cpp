  ...
  JVMCIEnv::CodeInstallResult result;
  {
    ...
    if (result != JVMCIEnv::ok) {
      ...
      nm =  nmethod::new_nmethod(method,
                                 ...
                                 compiler, comp_level, (JPortal || JPortalMethod) && method->is_jportal(),
      ...
      if (nm == NULL) {
        // The CodeCache is full.  Print out warning and disable compilation.
        {
          ...
          CompileBroker::handle_full_code_cache(CodeCache::get_code_blob_type(comp_level), (JPortal || JPortalMethod) && method->is_jportal());
        }
      } else {
