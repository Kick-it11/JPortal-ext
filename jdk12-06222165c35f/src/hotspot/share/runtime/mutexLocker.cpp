...
Mutex*   JPortalStubBuffer_lock       = NULL;
...
Monitor* JPortalEnable_lock           = NULL;
...
void mutex_init() {
  ...
  def(JPortalEnable_lock           , PaddedMutex  , special,     true,  Monitor::_safepoint_check_never);
  ...
  def(JPortalStubBuffer_lock       , PaddedMutex  , leaf,        true,  Monitor::_safepoint_check_never);
