...
void TieredThresholdPolicy::print_specific(EventType type, const methodHandle& mh, const methodHandle& imh,
  ...
  tty->print(" k=%.2lf,%.2lf", threshold_scale(CompLevel_full_profile, Tier3LoadFeedback, (JPortal || JPortalMethod) && mh->is_jportal()),
                               threshold_scale(CompLevel_full_optimization, Tier4LoadFeedback, (JPortal || JPortalMethod) && mh->is_jportal()));
...
bool TieredThresholdPolicy::loop_predicate(int i, int b, CompLevel cur_level, Method* method) {
  switch(cur_level) {
  case CompLevel_aot: {
    double k = threshold_scale(CompLevel_full_profile, Tier3LoadFeedback, (JPortal || JPortalMethod) && method->is_jportal());
  ...
  case CompLevel_full_profile: {
    double k = threshold_scale(CompLevel_full_optimization, Tier4LoadFeedback, (JPortal || JPortalMethod) && method->is_jportal());
