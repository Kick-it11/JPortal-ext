...
#include "../include/buffer_stream.hpp"
    ...
    : _klass(klass)
{
    ...
    if (stat(file_path.c_str(), &st) == 0)
    {
        ...
        if (file_read.is_open())
        {
            ...
            file_read.read((char *)_buffer, st.st_size);
            ...
            cerr << "grapbc: Cannot open file: " << file_path << endl;
        }
    }
}
                                          ...
                                          const int length)
{
    ...
    for (index = 1; index < length; ++index)
    {
        ...
        case CONSTANT_Utf8_info:
        {
            ...
            char *str = new char[str_len * sizeof(char) + 1];
                                      ...
                                      ConstantPool *cp)
{
    ...
    //     << endl;
    return new Method(method_name + method_signature, flags, code_start, code_length, _klass);
}
